...
function surfagility_scripts_and_jquery()
{
    ...
    wp_register_script( 'less', get_template_directory_uri() . '/js/less-1.6.3.min.js', array( 'bootstrap' ));
    wp_register_script( 'bootstrap', "http://netdna.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min.js", array( 'jquery' ));
